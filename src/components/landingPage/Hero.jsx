				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					...
					<div className="space-y-8 z-10 animate-slide-up">
						...
						<h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight animate-slide-up duration-700">
							Modernisation du <br />
							<span className="text-primary">Cabinet Dr. Amrani</span>
						</h1>

						<p className="text-xl text-muted-foreground leading-relaxed max-w-lg animate-slide-up duration-1000 delay-100">
					...
					<div className="relative flex items-center justify-center min-h-[500px]">
						{/* Frame */}
						<div className="relative w-full max-w-md h-[500px] rounded-[2.5rem] border-2 border-black bg-white" />
