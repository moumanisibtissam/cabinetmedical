...
export default function Planning() {
  ...
  // Fetch rendezVous depuis json-server
  useEffect(() => {
  ...
  // Fetch patients pour retrouver les noms
  useEffect(() => {
  ...
  // Fonction utilitaire pour afficher le nom du patient
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800">Planning </h1>
            ...
            <tbody className="divide-y divide-gray-50">
              {rendezVous.slice(0, 5).map((app) => (
                <tr key={app.id}>
                  ...
                  <td className="py-3 text-sm">{app.heure}</td>
