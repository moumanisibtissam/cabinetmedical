...
export default function RendezList() {
    ...
    const [editForm, setEditForm] = useState({ date: "", heure: "", raison: "", statut: "" });
    ...
    const handleEditSave = async (id) => {
        ...
        const updated = rendezVous.map((r) =>
                                ...
                                <tr key={r.id} className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="py-4">
                                        {editingId === r.id ? (
                                            ...
                                            <span
                                                className={`px-2 py-1 rounded-full text-xs font-semibold ${r.statut === "Confirmé"
